...
* [x] User can see latest comments for each photo (**bonus** - Show last 1 comment for each photo)
...
* [x] Display hashtags and tagging user in blue

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='https://github.com/huongvu/HW1-InstagramViewer/blob/master/Walkthrough-InstagramViewer.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
